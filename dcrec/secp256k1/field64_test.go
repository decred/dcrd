...
// hexToFieldVal64Internal converts the passed hex string into a [FieldVal64]
...
// values.
func hexToFieldVal64Internal(s string, allowOverflow bool) *FieldVal64 {
	if len(s)%2 != 0 {
		s = "0" + s
	}
...
// hexToFieldVal64 converts the passed hex string into a [FieldVal64] and will
// panic if there is an error.  Values that overflow are treated as an error.
//
// This is only provided for the hard-coded constants so errors in the source
// code can be detected. It will only (and must only) be called with hard-coded
// values.
func hexToFieldVal64(s string) *FieldVal64 {
	return hexToFieldVal64Internal(s, false)
}

// hexToFieldVal64WithOverflow converts the passed hex string into a
// [FieldVal64] and will panic if there is an error.  Values that overflow are
// NOT treated as an error.
//
// This is only provided for the hard-coded constants so errors in the source
// code can be detected. It will only (and must only) be called with hard-coded
// values.
func hexToFieldVal64WithOverflow(s string) *FieldVal64 {
	return hexToFieldVal64Internal(s, true)
}
...
func TestField64Zero(t *testing.T) {
	f := hexToFieldVal64("a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5")
	f.Zero()
...
func TestField64Equals(t *testing.T) {
	...
	for _, test := range tests {
		f := hexToFieldVal64WithOverflow(test.in1)
		f2 := hexToFieldVal64WithOverflow(test.in2)
		result := f.Equals(f2)
		if result != test.expected {
			t.Errorf("%s: wrong result -- got: %v, want: %v", test.name, result,
				test.expected)
...
func TestField64Add(t *testing.T) {
	...
	for _, test := range tests {
		f1 := hexToFieldVal64WithOverflow(test.in1)
		f2 := hexToFieldVal64WithOverflow(test.in2)
		expected := hexToFieldVal64(test.expected)
...
func TestField64IsGtOrEqPrimeMinusOrder(t *testing.T) {
	...
	for _, test := range tests {
		result := hexToFieldVal64(test.in).IsGtOrEqPrimeMinusOrder()
		if result != test.expected {
