...
// hexToModNScalarWithOverflow converts the passed hex string into a
// [ModNScalar] and will panic if there is an error.  Values that overflow are
...
// values.
func hexToModNScalarWithOverflow(s string) *ModNScalar {
	return hexToModNScalarInternal(s, true)
}
...
func TestModNScalarBytes(t *testing.T) {
	...
	for _, test := range tests {
		s := hexToModNScalarWithOverflow(test.in)
...
func TestModNScalarIsOdd(t *testing.T) {
	...
	for _, test := range tests {
		result := hexToModNScalarWithOverflow(test.in).IsOdd()
...
func TestModNScalarEquals(t *testing.T) {
	...
	for _, test := range tests {
		s1 := hexToModNScalarWithOverflow(test.in1)
		s2 := hexToModNScalarWithOverflow(test.in2)
		result := s1.Equals(s2)
		if result != test.expected {
...
func TestModNScalarAdd(t *testing.T) {
	...
	for _, test := range tests {
		...
		s1 := hexToModNScalarWithOverflow(test.in1)
		s2 := hexToModNScalarWithOverflow(test.in2)
		expected := hexToModNScalar(test.expected)
...
func TestModNScalarMul(t *testing.T) {
	...
	for _, test := range tests {
		v1 := hexToModNScalarWithOverflow(test.in1)
		v2 := hexToModNScalarWithOverflow(test.in2)
		expected := hexToModNScalar(test.expected)
...
func TestModNScalarSquare(t *testing.T) {
	...
	for _, test := range tests {
		v := hexToModNScalarWithOverflow(test.in)
		expected := hexToModNScalar(test.expected)
...
func TestModNScalarIsOverHalfOrder(t *testing.T) {
	...
	for _, test := range tests {
		result := hexToModNScalarWithOverflow(test.in).IsOverHalfOrder()
		if result != test.expected {
			t.Errorf("%s: unexpected result -- got: %v, want: %v", test.name,
				result, test.expected)
			continue
