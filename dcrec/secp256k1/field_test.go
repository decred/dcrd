...
func TestFieldZero(t *testing.T) {
	f := mustFieldVal("a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5a5")
	f.Zero()
...
func TestFieldIsOne(t *testing.T) {
	...
	for _, test := range tests {
		f := mustFieldValWithOverflow(test.in)
		if test.normalize {
			f.Normalize()
		}
		result := f.IsOne()
...
func TestFieldEquals(t *testing.T) {
	...
	for _, test := range tests {
		f := mustFieldValWithOverflow(test.in1).Normalize()
		f2 := mustFieldValWithOverflow(test.in2).Normalize()
		result := f.Equals(f2)
		if result != test.expected {
			t.Errorf("%s: wrong result -- got: %v, want: %v", test.name, result,
				test.expected)
...
func TestFieldAdd(t *testing.T) {
	...
	for _, test := range tests {
		// Parse test hex.
		f1 := mustFieldValWithOverflow(test.in1).Normalize()
		f2 := mustFieldValWithOverflow(test.in2).Normalize()
		expected := mustFieldVal(test.expected).Normalize()
...
func TestFieldIsGtOrEqPrimeMinusOrder(t *testing.T) {
	...
	for _, test := range tests {
		result := mustFieldVal(test.in).IsGtOrEqPrimeMinusOrder()
		if result != test.expected {
			t.Errorf("%s: unexpected result -- got: %v, want: %v", test.name,
				result, test.expected)
			continue
