...
// FutureCreateUnsignedTicketResult is a future promise to deliver the result of a
// CreateUnsignedTicket RPC invocation (or an applicable error).
type FutureCreateUnsignedTicketResult chan *response

// Receive waits for the response promised by the future and returns the
// result of creating unsigned ticket.
...
// returned instance.
//
// See CreateUnsignedTicket for the blocking version and more details.
...
// CreateUnsignedTicket creates unsigned tickets.
func (c *Client) CreateUnsignedTicket(fromAccount string,
	spendLimit dcrutil.Amount, minConf *int, ticketAddress dcrutil.Address,
	numTickets *int, poolAddress dcrutil.Address, poolFees *dcrutil.Amount,
	expiry *int, ticketFee *dcrutil.Amount) ([]string, error) {
