...
[![Doc](https://img.shields.io/badge/doc-reference-blue.svg)](https://pkg.go.dev/github.com/decred/dcrd/rpcclient)
...
* [API Reference](https://pkg.go.dev/github.com/decred/dcrd/rpcclient)
