...
func TestIsTreasurybaseTx(t *testing.T) {
	tests := []struct {
		...
		name: "test generated treasury base",
		tx: "03000000010000000000000000000000000000000000000000000000000000000" +
			"000000000ffffffff00ffffffff0200f2052a01000000000001c10000000000" +
