...
//
// This is part of the Indexer interface.
func (idx *TxIndex) ConnectBlock(dbTx database.Tx, block, parent *dcrutil.Block, stxos []blockchain.SpentTxOut) error {
...
//
// This is part of the Indexer interface.
func (idx *TxIndex) DisconnectBlock(dbTx database.Tx, block, parent *dcrutil.Block, stxos []blockchain.SpentTxOut) error {
	// NOTE: The fact that the block can disapprove the regular tree of the
