...
import (
	...
	"github.com/decred/dcrd/integration/gobuilder"
	"github.com/decred/dcrd/integration/harness"
	"github.com/decred/dcrd/integration/harness/memwallet"
	"github.com/decred/dcrd/integration/harness/testnode"
)
...
func Setup() *SimpleTestSetup {
	...
	setup.nodeGoBuilder = setupBuild("dcrd", setup.WorkingDir.Path())
