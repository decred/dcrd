...
var helpDescsEnUS = map[string]string{
	...
	// GenerateCmd help
	"generate--synopsis": "Generates a set number of blocks (testnet or simnet only) and returns a JSON\n" +
		" array of their hashes.",
	"generate-numblocks":   "Number of blocks to generate or 0 to cancel an active instance",
