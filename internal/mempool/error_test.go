...
func TestErrorCodeStringer(t *testing.T) {
	tests := []struct {
		...
		{ErrInsufficientPriority, "ErrInsufficientPriority"},
...
func TestErrorKindIsAs(t *testing.T) {
	tests := []struct {
		...
		err:       ruleError(ErrOrphanPolicyViolation, ""),
		target:    ErrOrphanPolicyViolation,
		wantMatch: true,
		wantAs:    ErrOrphanPolicyViolation,
	}, {
		...
		err:       ruleError(ErrOrphanPolicyViolation, ""),
		target:    ruleError(ErrOrphanPolicyViolation, ""),
		wantMatch: true,
		wantAs:    ErrOrphanPolicyViolation,
	}, {
		...
		err:       ErrOrphanPolicyViolation,
		target:    ruleError(ErrMempoolDoubleSpend, ""),
		wantMatch: false,
		wantAs:    ErrOrphanPolicyViolation,
	}, {
