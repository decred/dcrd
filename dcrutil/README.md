...
[![Doc](https://img.shields.io/badge/doc-reference-blue.svg)](https://pkg.go.dev/github.com/decred/dcrd/dcrutil/v4)
...
This package is part of the `github.com/decred/dcrd/dcrutil/v4` module.  Use the
