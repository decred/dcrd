...
type config struct {
	...
	PeerIdleTimeout      time.Duration `long:"peeridletimeout" description:"Duration of inactivity before a peer is timed out. Valid time units are {s, m, h}. Duration should be strictly greater than 30 seconds."`
