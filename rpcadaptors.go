...
type rpcConnManager struct {
	...
	ConnectedCountImpl          func() int32
	NetTotalsImpl               func() (uint64, uint64)
	BroadcastMessageImpl        func(msg wire.Message, excluded ...*serverPeer)
	AddRebroadcastInventoryImpl func(iv *wire.InvVect, data interface{})
	RelayTransactionsImpl       func(txns []*dcrutil.Tx)
	AddedNodeInfoImpl           func() []*serverPeer
}
...
func (cm *rpcConnManager) BroadcastMessage(msg wire.Message, excluded ...*serverPeer) {
	cm.BroadcastMessageImpl(msg, excluded...)
}
