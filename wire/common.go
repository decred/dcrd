...
// isStrictAsciiBytes determines returns true if the provided bytes only
// contains runes that are within the strict ASCII range.
func isStrictAsciiBytes(b []byte) bool {
