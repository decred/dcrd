...
// be sent on a cfiltersv2 message.
//
...
// MsgCFilterV2 implements the Message interface and represents a cfiltersv2
// message.  It is used to deliver a batch of version 2 committed gcs filter for a given
// range of blocks, along with a proof that can be used to prove the filter is committed to
// by the block header.
//
...
// NewMsgCFiltersV2 returns a new cfiltersv2 message that conforms to the Message
