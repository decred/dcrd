...
func TestCFiltersV2WireErrors(t *testing.T) {
	...
	tests := []struct {
		...
		{baseCFiltersV2, baseCFiltersV2Encoded, pver, 66, io.ErrShortWrite, io.ErrUnexpectedEOF},
		...
		{maxDataCFiltersV2, maxDataCFilterV2Encoded, pver, 38, ErrFilterTooLarge, ErrVarBytesTooLong},
		// Force error with greater than max proof hashes.
		{maxHashesCFiltersV2, maxHashesCFilterV2Encoded, pver, 68, ErrTooManyProofs, ErrTooManyProofs},
